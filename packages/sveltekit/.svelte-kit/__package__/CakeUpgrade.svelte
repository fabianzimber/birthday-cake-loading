...
export let minTier = "rich";
export let feature = undefined;
export let loader;
export let strategy = "idle";
...
const setup = () => {
    ...
    if (s === "idle") {
        ...
        if (typeof anyWindow.requestIdleCallback === "function") {
            const timeoutMs = typeof strategy === "object" && strategy.type === "idle" ? strategy.timeoutMs : undefined;
    ...
    if (s === "visible") {
        ...
        const opts = typeof strategy === "object" && strategy.type === "visible"
